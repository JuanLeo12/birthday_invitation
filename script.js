...
function initAutoScrollPeek() {
    ...
    function peekAction() {
        ...
        // Exactamente el 25% de la altura de la PANTALLA ACTUAL.
        ...
        const distance = window.innerHeight * 0.25; 
        const duration = 1200; // 1.20 segundos para un viaje aún más corto
